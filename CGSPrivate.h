...
typedef enum {
    ...
    CGSFade,                              // Cross-fade.
    CGSZoom,                              // Zoom/fade towards viewer.
...
typedef enum {
    ...
    CGSBottomRight,     // CGSSwap: Old desktop to bottom right, new from top left.
    CGSDownTopRight,    // CGSSwap: Old desktop moves down, new from top right.
    CGSUp,              // Old desktop moves up.
    CGSTopLeft,         // Old desktop moves top left.
    CGSTopRight,        // CGSSwap: Old to top right, new from bottom left.
    CGSUpBottomRight,   // CGSSwap: Old desktop up, new from bottom right.
    CGSInBottom,        // CGSSwap: Old in, new from bottom.
    CGSLeftBottomRight, // CGSSwap: Old one moves left, new from bottom right.
    CGSRightBottomLeft, // CGSSwap: Old one moves right, new from bottom left.
    CGSInBottomRight,   // CGSSwap: Old one in, new from bottom right.
...
// These all create files called /tmp/WindowServer + suffix, from constants below:
